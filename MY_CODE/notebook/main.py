...
root.protocol('WM_DELETE_WINDOW', notepad_exit)  # закрывает программу через крестик
...
# -------------------------- Что можно добавить в параметры по умолчанию --------------------------

# root.attributes("-toolwindow", True) - отключение верхней панели, кроме крестика(убрать сворач. и расширение окна)
# root.attributes("-fullscreen", True) - расширение окна на весь экран при открытии