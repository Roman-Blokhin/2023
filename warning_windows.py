...
Button (text = 'Warning', font = ('Arial', 15, 'normal'), bd = 5, activeforeground='red', command=warning).\
        grid (row= 0, column = 2, stick = 'wens', padx = 5, pady = 5)

Button (text = 'Error', font = ('Arial', 15, 'bold'), bd = 5, bg = '#87CEEB', activebackground='red',
        command=error).grid (row= 1, column = 1, stick = 'wens', padx = 5, pady = 5)
