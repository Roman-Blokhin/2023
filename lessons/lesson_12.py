...
# если нам нужно передать неограниченное кол-во неименованных аргументов, а потом именованные параметры:
def ui(*args, sep='#', end='%'):  # используем параметры sep и end
    print(args, sep, end)


ui(1, 3, 5, 790, sep='Roman')
ui(1, 3, end='Rob')
