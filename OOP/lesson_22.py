...
# ПОЛИМОРФИЗМ - ВОЗМОЖНОСТЬ ОБРАБОТКИ РАЗНЫХ ОБЪЕКТОВ, ИСПОЛЬЗУЯ ОДИМ МЕТОД, ПО НАЗВАНИЮ
# этого можно добиться, если у каждого метода в разных классах будет одно и тоже название
# вместо: get_rect_area, get_sq_area, get_circle_area, нужно указать, к примеру, get_area
